 ...
 */
public abstract class AbstractGRASP_TP_INTELLIGENT<E > {
	...
	/**
	 * Constructor for the AbstractGRASP_TP class.
	 * 
	 * @param objFunction
	 ...
	 */
	public AbstractGRASP_TP_INTELLIGENT(Evaluator<E> objFunction, Double alpha, Integer iterations) {
		...
		while (!constructiveStopCriteria()) {
			...
			for (E c : CL) {
				...
				if (deltaCost <= minCost + alpha * (maxCost - minCost)) {
					RCL.add(c);
					//K.add(lambda*deltaCost + eliteSolutionsPool.getCount(c));
				}
			}
